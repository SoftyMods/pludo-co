...
def advance_month(cash_balance, companies, offshore_companies):
    cash_balance = update_cash_balance(cash_balance, companies, offshore_companies)
    return cash_balance

def update_cash_balance(cash_balance, companies, offshore_companies):
        ...
        if company['offshore']:
            for offshore_company in offshore_companies:
                if company in offshore_company['companies']:
                    ...
                    break
        taxed_profit = profit * (1 - tax_rate)
        cash_balance += taxed_profit
    return cash_balance

def main_game_loop(player_name, cash_balance, companies, business_types, management_personnel, offshore_locations):
    months_passed = 0
    offshore_companies = []
    ...
    while True:
        ...
        if choice == 1:
            ...
            cash_balance = advance_month(cash_balance, companies, offshore_companies)
            months_passed += 1
        elif choice == 9:
...
main_game_loop(player_name, cash_balance, companies, business_types, management_personnel, offshore_locations)